...
class EmbeddingsConfig(BaseModel):
    ...
    cache_path: str = "~/.ctxkit/embed_cache"


class VectorStoreConfig(BaseModel):
    backend: Literal["chroma"] = "chroma"
    persist_path: str = "~/.ctxkit/chroma_db"
    collection_name: str = "ctxkit_vault"
...
class BackupConfig(BaseModel):
    enabled: bool = True
    backup_path: str = "~/.ctxkit/backups"
...
class LLMConfig(BaseModel):
    ...
    # Synthesis backend + model — used for synthesise() during ctxkit search.
...
class CLIConfig(BaseModel):
    ...
    verbose: bool = False
    # output_folder is not configurable — always <vault.path>/ctxkit-output/


class LoggingConfig(BaseModel):
    enabled: bool = True
    log_path: str = "~/.ctxkit/logs"
