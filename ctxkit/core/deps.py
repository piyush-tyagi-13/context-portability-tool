...
Install target is always sys.executable — works correctly whether ctxkit was
...
def required_backends(cfg) -> list[DepStatus]:
    """
    Given a CtxKitConfig, return DepStatus for every backend the config
