...
from ctxkit.core.retriever.context_assembler import AssembledContext
from ctxkit.config.models import RetrieverConfig
...
def format_context(ctx: AssembledContext, cfg: RetrieverConfig) -> str:
    ...
    header_parts = [f"Assembled by ctxkit"]
    ...
    if ctx.signpost:
        ...
        for source_file, breadcrumbs in ctx.signpost:
            ...
            lines.append(f"| {display} | {sections} | `ctxkit search \"{terms}\"` |")
