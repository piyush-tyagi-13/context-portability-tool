...
from ctxkit.core.ingester.classification_engine import ClassificationDecision
from ctxkit.core.ingester.conflict_detector import ConflictPair
...
class ProposalGenerator:
    ...
    def generate(
        ...
        from ctxkit.llm.llm_layer import ClassificationResult
